...
let sel = document.getElementById('petSelect');
let image = document.getElementById("petImg");

function pasteimg(event) {
    let s = event.target.value
    //console.log(petsImageUrls[s])
    image.src = petsImageUrls[s]
}
sel.addEventListener("change", pasteimg);